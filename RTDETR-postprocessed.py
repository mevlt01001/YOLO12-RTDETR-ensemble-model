...
postprocess = RTDETR_postprocess(score_threshold=0.0, iou_threshold=1.0)
...
onnx.save(RTDETR_postprocessed, f"onnx_folder/R_{postprocess.NMS.score_threshold}_{postprocess.NMS.iou_threshold}.onnx")